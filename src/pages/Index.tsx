...
const SocialStrip = () => {
  const socials = [
    { label: "GitHub", href: "https://github.com/FaizanAhmeddd27" },
    { label: "LinkedIn", href: "https://www.linkedin.com/in/faizan-ahmed-7b4364330/" },
    { label: "Email", href: "mailto:faizannn27@gmail.com" },
  ];
  return (
    <motion.div
...
const MobileSocialStrip = () => {
  const socials = [
    { label: "Github", icon: Github, href: "https://github.com/FaizanAhmeddd27" },
    { label: "LinkedIn", icon: Linkedin, href: "https://www.linkedin.com/in/faizan-ahmed-7b4364330/" },
    { label: "Email", icon: Mail, href: "mailto:faizannn27@gmail.com" },
  ];
  return (
    <motion.div
      initial={{ opacity: 0, x: 20 }}
