...
const About = () => {
  ...
  return (
    <section className="h-screen w-full bg-white text-black font-sans px-6 md:px-12 lg:px-16 pt-28 md:pt-32 lg:pt-36 overflow-hidden flex items-center justify-center relative">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-y-6 md:gap-x-12 w-full max-w-[1600px] mx-auto">
        ...
        <div className="md:col-span-9 lg:col-span-9 flex flex-col gap-6 md:gap-12">
          ...
          <motion.div style={{ y: y3, opacity: opacity3 }} className="flex flex-col gap-2">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div>
                ...
                <p className="font-sans text-base md:text-lg lg:text-xl font-normal text-black/60 leading-tight tracking-tight mt-2">
              ...
              <div>
                <p className="font-sans text-xl md:text-2xl lg:text-3xl font-bold leading-tight tracking-tight">
                  NCCS (National Center for Cyber Security) – NEDUET, Karachi, Pakistan
                </p>
                <p className="font-sans text-xl md:text-2xl lg:text-3xl font-normal text-black/70 leading-tight tracking-tight">
